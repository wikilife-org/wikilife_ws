...
TEST_HUMAN_INTERNAL_USER_NAME = "TEST_HUMAN4"
TEST_TWITTER_USER_ID = "1234569"
...
class UsersSettingsTests(BaseTest):
    ...
    def setUp(self):
        ...
        self._crawler_user_id = self._create_crawler_user(TEST_TWITTER_USER_ID)

    def tearDown(self):
        try:
            self._delete_human_user(self._human_user_id)
            self._delete_crawler_user(self._crawler_user_id)
        except Exception, e:
            print "tearDown: %s" % e
